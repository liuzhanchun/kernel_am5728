...
static int ad5724r_probe(struct spi_device *spi)
{
...
static int ad5724r_remove(struct spi_device *spi)
{
...
#ifdef CONFIG_OF
static const struct of_device_id of_ad5724r_match_ids[] = {
	{ .compatible = "adi,ad5724r", .data = "ad5724r" },
	{ .compatible = "adi,ad5734r", .data = "ad5734r" },
	{ .compatible = "adi,ad5754r", .data = "ad5754r" },
	{},
};
MODULE_DEVICE_TABLE(of, of_ad5724r_match_ids);
#endif
...
static struct spi_driver ad5724r_driver = {
	.driver = {
		   .name = "ad5724r",
		   .owner = THIS_MODULE,
		   .of_match_table = of_match_ptr(of_ad5724r_match_ids),
		   },
	.probe = ad5724r_probe,
	.remove = ad5724r_remove,
	.id_table = ad5724r_id,
};
